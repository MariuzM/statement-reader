...
const YearModal = ({
  ...
  return (
    ...
    >
      {grouped.length ? (
        <>
          <div className="text-subtle mb-1 flex items-center gap-2 border-b border-[#1d2128] pb-3 text-[11px]">
              ...
              return (
                <li key={g.key} className="border-b border-[#1d2128] last:border-b-0">
                  <div className="flex items-center gap-3 py-2.5">
                    ...
                    >
                      <span className="text-subtle w-2.5 shrink-0 text-xs">
                        {isOpen ? '▾' : '▸'}
                      </span>
                      ...
                      <span className={`truncate text-sm font-medium ${off ? 'line-through' : ''}`}>
                        {g.name}
                      </span>
